...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.channel'
        db.alter_column('mediacontent_video', 'channel_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['mediacontent.VideoChannel']))

    def backwards(self, orm):

        # Changing field 'Video.channel'
        db.alter_column('mediacontent_video', 'channel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mediacontent.Album'], null=True))
    ...
    models = {
        ...
        'mediacontent.image': {
            ...
            'album': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'image'", 'null': 'True', 'to': "orm['mediacontent.Album']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'mediacontent.video': {
            ...
            'channel': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'video'", 'null': 'True', 'to': "orm['mediacontent.VideoChannel']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'movies_linked': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['movie.Movie']", 'symmetrical': 'False'}),
            'person_linked': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['person.Person']", 'symmetrical': 'False'}),
